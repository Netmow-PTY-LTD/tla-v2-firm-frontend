...
//   placeholder = "",
//   onSelect,
//   dependentOn, // optional: parent field name to watch
// }) => {
//   const { control, watch, setValue } = useFormContext();
//   const [query, setQuery] = useState("");

//   // Watch parent value if dependentOn is provided
//   const parentValue = dependentOn ? watch(dependentOn) : null;

//   // Reset field when parent changes
//   useEffect(() => {
//     if (dependentOn) setValue(name, null);
//   }, [parentValue]);
