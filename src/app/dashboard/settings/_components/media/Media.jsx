...
import { useGetFirmMediaQuery } from "@/store/firmFeatures/firmApiService";
    ...
    <div className="max-w-[900px] mx-auto">
      ...
      >
        <div className="flex flex-col gap-3 ">
          <div className="mb-1">
            <h3 className="heading-lg font-semibold text-black mb-1">
              Company Banner Image
            </h3>
            <p className="text-sm text-gray-500">
              Showcase your company with a professional banner. This image will
              appear at the top of your public profile and helps create a strong
              first impression for clients and partners.
              <br />
            </p>
          </div>
          <BannerUploader
