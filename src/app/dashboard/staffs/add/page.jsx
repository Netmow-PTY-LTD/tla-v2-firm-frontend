...
const SelectAllPermissions = ({ permissionOptions }) => {
  ...
  const handleToggle = () => {
    // If all are currently selected, we want to deselect all.
    // Otherwise (none or some selected), we want to select all.
    const newValue = !allSelected;

    // Update the entire permissions object at once for better synchronization
