...
import { useGetSingleLawyerRequestQuery, useUpdateLawyerRequestMutation } from "@/store/firmFeatures/lawyerRequest/lawyerRequest";
...
export default function Page({ params }) {
    ...
    const handleStatusUpdate = async (newStatus) => {
        ...
        if (newStatus === "rejected") {
            payload.rejectionReason = "Unfortunately, your request to join this firm has been declined."; // Hardcoded rejection message
        }
        ...
        try {
            ...
            toast.success(
                `Request has been ${newStatus === "approved" ? "approved" : "rejected"} successfully!`
            );
    ...
    return (
        <div className="max-w-4xl mx-auto p-4 sm:p-6 bg-white rounded-lg shadow-md space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0">
                ...
                <span
                    className={`px-3 py-1 text-sm rounded-full font-medium ${status === "pending"
            ...
            <div className="border-t border-gray-200 pt-4">
                <h3 className="text-lg sm:text-xl font-semibold mb-2">Request Message</h3>
